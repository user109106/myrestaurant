...
@section('content')
<?php $tab = 'cash-confirm'; ?>
<section id="inner-headline">
    <div class="container">
        
        <div class="row">
            <div class="col-lg-12">
                <h2 style="color:green;" class="pageTitle">SUCCESSFULL!</h2>
            </div>
        </div>
    </div>
</section> 
...
<div class="container">
    ...
    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 center">
        <p style="color:green;">Thank for your order.Our delivery service department will contact you in a moment.. Till then, stay hungry!</p><br><br><br>
