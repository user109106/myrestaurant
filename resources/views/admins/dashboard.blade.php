    ...
    <div id="page-inner">
        ...
        <div class="dashboard-cards"> 
                ...
                <div class="col-xs-12 col-sm-12 col-md-7"> 
                    <div class="cirStats">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6"> 
                                <div class="card-panel text-center">
                                    <h4>Customers</h4>
                                    <div class="easypiechart" id="easypiechart-teal" data-percent="95" ><span class="percent">95%</span>
                                    </div> 
                                </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6"> 
            ...
            <div class="fixed-action-btn horizontal click-to-toggle">
                ...
                <ul>
                    <li>
                        <a class="btn-floating red"><i class="material-icons">track_changes</i></a>
                    </li>
                    <li>
