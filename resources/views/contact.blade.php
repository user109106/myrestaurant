		...
		<div class="row"> 
            <div class="col-md-12">
                <div class="about-logo">
                    ...
                    <p>Contact us for anything. Say something more on it.Contact us for anything. Say something more on it.Contact us for anything. Say something more on it.Contact us for anything. Say something more on it.Contact us for anything. Say something more on it.</p>
                </div>  
            </div>
        </div>
	<div class="row">
...
<!-- Form itself -->
        <form name="sentMessage" id="contactForm"  action="{{ route('contact.submit') }}" method="post"> 
            @csrf
            ...
            <div class="input-field"> 
                <textarea rows="10" cols="100" required class="form-control materialize-textarea"  required="required"
