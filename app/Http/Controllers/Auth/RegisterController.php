    ...
    public function register(Request $request)
    {
        ...
        if($validator->passes()){
            ...
            Mail::send('mail.activation', $user, function($message) use ($user){
                ...
                $message->subject('blogpost.com - Activation Code');
            });
            return redirect()->to('login')->with('success', "We have sent an activation code to your mail address.Please check your email to login.Thank you.");
    ...
    public function userActivation($token)
    {
       ...
       if(!is_null($check)){
            ...
            if ($user->is_activated == 1) {
                return redirect()->to('login')->with('success', "User is already active");
            }  
